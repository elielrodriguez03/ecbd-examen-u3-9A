...
```text
Nombre: Angel Daniel Ocampo Martinez
Grupo: 9A
Materia: 
...
Errores:
Conclusion breve:
Estuvo dificil y tal vez no lo termine pero fue un buen comienzo y creo que el entrenar modelo sirve para llevar un mejor control de los datos al igual que 
automatizar de cierta manera los datos 
```
