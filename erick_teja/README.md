...
```text
Nombre: Erick Humberto Teja Carvajal
Grupo: 9°A
...
Coincidencias: 6
Errores: 4
Conclusion breve: El modelo fue entrenado correctamente, al principio tuvo una exactitud del 100%, pero al incluir las nuevas ventas con ventas cercanas al limite de 1000, el modelo no logro predecir correctamente una venta real
```
