...
```text
Nombre: Portilla Palestina Viridiana
Grupo: 9A
...
Errores: 7
Conclusion breve:
Los modelos de aprendizaje supervisado a pesar de estar entrenados con resultados conocidos, no quedan excentos de fallos o predicciones incorrectas, esto depende de que tantos datos tuvieron para aprender y que variaciones tenian estos
```
